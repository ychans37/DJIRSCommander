...
using CommanderConsole.Gimbal.Ronin.Protocol;
using static CommanderConsole.Service.SerialDevice;
using CommanderConsole.Model;
...
namespace CommanderConsole.Gimbal.Ronin
{
